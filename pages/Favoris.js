...
function Favoris() {
  ...
  useEffect(() => {
    try {
      ...
      axios
        .get(
          "http://185.98.139.246:9090/ogatemanagement-api/client/recherchermespublicationfavorisparpage?page=0&taille=10",
          config
        )
        .then((response) => {
          setFavoris(response.data.donnee.publications),
